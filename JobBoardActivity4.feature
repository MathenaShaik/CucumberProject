...
Scenario Outline: ​Post a job using details passed from the Feature file
	...
	Examples:
	  ...
	  | abc1@gmail.com | SDET Tester 001 | KOLKATA   | Test job 1  | http://abc.com   | ABC India Pvt. Ltd. |
    | abc2@gmail.com | SDET Tester 002 | Bangalore | Test job 2  | https://abc1.com | ABC India Pvt. Ltd. |